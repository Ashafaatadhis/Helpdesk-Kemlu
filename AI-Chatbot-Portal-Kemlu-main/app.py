...
from services.smalltalk_service import get_smalltalk_reply
...
def ask():
    ...
    has_context = bool(session_contexts.get(session_id))
    ...
    if intent == "smalltalk":
        ...
        reply = get_smalltalk_reply(user_input_original)
    ...
    if last_context and not is_new_topic:
        logging.info("Checking if this message matches a direct keyword response before using the previous context.")
