...
Route::middleware(['auth:web,admin_helpdesk,admin_aplikasi,teknisi,user', 'session.tracking', 'session.timeout', 'inertia'])->group(function () {
    ...
    Route::middleware('role:admin_helpdesk')->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/kalender-dinas', [\App\Http\Controllers\KegiatanController::class, 'kalender'])->name('kalender-dinas');
        Route::get('/kegiatan-export', [\App\Http\Controllers\KegiatanController::class, 'export'])->name('kegiatan.export');
