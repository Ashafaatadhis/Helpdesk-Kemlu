      ...
      >
        ...
        <ul class="navbar-nav justify-content-end">
          <li v-if="!isAuthenticated" class="nav-item d-flex align-items-center">
            ...
            >
              <i class="fa fa-user" :class="isRTL ? 'ms-2' : 'me-2'"></i>
              Login
            </router-link>
          </li>

          <li v-else class="nav-item d-flex align-items-center">
            <button @click="handleLogout" class="btn btn-sm mb-0 btn-danger">
              <i class="fas fa-sign-out-alt" :class="isRTL ? 'ms-2' : 'me-2'"></i>
              Logout
            </button>
          </li>
              ...
              <li class="mb-2">
                <a class="dropdown-item border-radius-md" href="javascript:;">
                  <div class="py-1 d-flex">
                    <div class="my-auto">
                      <img
                        src="../assets/img/Helpdesk-Logo.png"
