...
STATIC_FALLBACKS = {
    "id": {
        r"kekonsuleran|konsuler|paspor|visa|legalisasi": (
    ...
    "en": {
        r"consular|passport|visa|legalization": (
...
KEYWORDS_ID = [
    ...
    {
        "pattern": r"(?:((?:prosedur|syarat|cara|membuat|buat|perpanjang|perpanjangan|biometrik|dokumen|hilang).*(paspor))|paspor.*(?:hilang|lost)|\bpaspor\b)",
        "priority": 10,
    ...
    {
        "pattern": r"perwakilan asing|kedutaan asing|konsulat asing|kedutaan besar negara sahabat|perwakilan negara sahabat|kedutaan besar .* negara sahabat",
        "priority": 3,
...
KEYWORDS_EN = [
    ...
    {
        "pattern": r"(?:((?:procedure|requirements|how to|renew|apply|make|create|biometric|document|missing|lost).*(passport))|passport.*(?:lost|missing)|\bpassport\b)",
        "priority": 10,
